...
/*4. Escriu una consulta per mostrar restaurant_id,
name, borough i zip code, però excloure el camp _id per tots
els documents en la col·lecció Restaurants*/
...
/* 11. Escriu una consulta de MongoDB per a trobar els restaurants que
...
db.restaurants.find().pretty().sort(
  {
    name: 1,
    _id: 1,
    address: 1,
...
db.restaurants.find({},{cuisine: 1, borough: 1}).pretty().sort(
  {
      cuisine: 1,
      borough: -1
  })
